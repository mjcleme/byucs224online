...
*Learning material derived from `2b IntroductionToMemory.pptx` (textbook §2.1.2–2.1.5)*

> **📍 Course context (Winter 2026) — Units 2 & 4: Memory basics → Types, Memory & Typecasting.**
> **Read:** CS:APP §2.1 (memory) and §2.2 (Unit 4).
> **Supports:** Project 1: myxxd (due **Fri Jan 23**) · Lab 4: Types, Memory & Typecasting (due **Fri Jan 30**).
